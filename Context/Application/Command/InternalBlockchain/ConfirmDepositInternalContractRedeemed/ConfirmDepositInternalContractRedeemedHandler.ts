...
export default class ConfirmDepositInternalContractRedeemedHandler
    implements UseCase<ConfirmDepositInternalContractRedeemed, void>
{
    constructor(private repository: DepositRepositoryInterface, private internalBlockchain: InternalBlockchain) {}
    ...
    async execute(command: ConfirmDepositInternalContractRedeemed): Promise<void> {
        ...
        const redeemOperations = await this.internalBlockchain.getRedeemOperations(
